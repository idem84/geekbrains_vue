    ...
    <div class="calculator">
      ...
      <div class="buttons">
        ...
        <div class="two">
          ...
          <button @click="enterSign('x2')">X&sup2;</button>
          ...
          <button @click="enterSign('divide')">&divide;</button>
    ...
    enterEqual: function () {
      switch (this.currentSign) {
        ...
        case '/':
          ...
          break
        case 'x2':
          this.ans = Math.pow(parseFloat(this.temp), parseFloat(this.display));
          break
        case 'divide':
          this.ans = this.div(parseFloat(this.temp), parseFloat(this.display));
          break
      }
